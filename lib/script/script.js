...
Script.prototype.isPublicKeyHash256Out = function() {
  return !!(this.chunks.length === 14 &&
    this.chunks[0].opcodenum === Opcode.OP_NOP9 &&
    ...
    this.chunks[9].opcodenum === Opcode.OP_SHA256 &&
    this.chunks[10].buf &&
    this.chunks[10].buf.length === 32 &&
...
Script.prototype.getPublicKeyHash256 = function() {
  $.checkState(this.isPublicKeyHash256Out(), 'Can\'t retrieve PublicKeyHash from a non-PKH output');
...
Script.buildPublicKeyHashOut256 = function(to, coldStakingAddress) {
  ...
  if (coldStakingAddress){
    var csa = new Address(coldStakingAddress);
    s.add(Opcode.OP_NOP9)
     .add(Opcode.OP_IF)
     .add(Opcode.OP_DUP)
     .add(Opcode.OP_HASH160)
     .add(csa.hashBuffer)
